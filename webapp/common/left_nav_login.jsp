    ...
    <td class="left">
            ...
            <table>
              ...
              <form action="j_security_check" method="POST">
                ...
                <tr>
                  <td colspan="2" align="right"><input type="submit" value="GO &#187;" class="formbutton" style="border-style: outset;" tabindex="3" /></td>
                </tr>
              </form>
              ...
              <tr>
                <td align="center" colspan="2"><img src="images/nurse.jpg" width="134" height="141" border="0" alt="" /></td>
              </tr>
            </table>
        </td>
