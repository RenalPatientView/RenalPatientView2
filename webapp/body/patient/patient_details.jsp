...
<html:xhtml/>
        ...
        <table width="440" border="0" cellspacing="1" cellpadding="3">
          ...
          <logic:present name="patient">
            <tr valign="top">
              <td class="tableheader" colspan="2">Patient Details for <bean:write name="patient" property="forename"/> <bean:write name="patient" property="surname"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">Last Name</td>

              <td class="tablecell"><bean:write name="patient" property="surname"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">First Name</td>

              <td class="tablecell"><bean:write name="patient" property="forename"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">Date of Birth (yyyy-mm-dd)</td>

              <td class="tablecell"><bean:write name="patient" property="dateofbirth"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">NHS Number</td>

              <td class="tablecell"><bean:write name="patient" property="nhsno"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">Hospital Number</td>

              <td class="tablecell"><bean:write name="patient" property="hospitalnumber"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">Address</td>

              <td class="tablecell"><bean:write name="patient" property="address1"/><br />
              <bean:write name="patient" property="address2"/><br />
              <bean:write name="patient" property="address3"/></td>
            </tr>

            <tr valign="top">
              <td class="tablecellbold">Postcode</td>

              <td class="tablecell"><bean:write name="patient" property="postcode"/></td>
            </tr>
            ...
            <logic:notEmpty name="patient" property="telephone1">
              <tr valign="top">
                ...
                <td class="tablecell"><bean:write name="patient" property="telephone1"/></td>
              </tr>
           </logic:notEmpty>
            ...
            <logic:notEmpty name="patient" property="telephone2">
              <tr valign="top">
                ...
                <td class="tablecell"><bean:write name="patient" property="telephone2"/></td>
              </tr>
            </logic:notEmpty>
            ...
            <logic:notEmpty name="patient" property="mobile">
              <tr valign="top">
                ...
                <td class="tablecell"><bean:write name="patient" property="mobile"/></td>
              </tr>
            </logic:notEmpty>
<%--
            <tr valign="top">
...
--%>
            ...
            <tr valign="top">
              ...
              <logic:present name="treatmentCode">
                <td class="tablecell"><bean:write name="treatmentCode" property="description"/></td>
              </logic:present>
            ...
            <tr valign="top">
              ...
              <td class="tablecell">
                ...
                <logic:notEmpty name="uktstatus">
                  Kidney   : <bean:write name="uktstatus" property="uktkidney"/>
                  <br />
                  Pancreas : <bean:write name="uktstatus" property="uktpancreas"/>
                </logic:notEmpty>
                   <br />(<a href="http://www.renal.org/rixg/transplant.html" target="_blank">Explain this</a>)</td>
            </tr>
              ...
              <td class="tablecell">
                  <logic:present name="otherDiagnoses">
                     <logic:iterate id="otherDiagnosis" name="otherDiagnoses" >
                       <bean:write name="otherDiagnosis" property="diagnosis"/><br />
                     </logic:iterate>
                  </logic:present>
              </td>
            </tr>
