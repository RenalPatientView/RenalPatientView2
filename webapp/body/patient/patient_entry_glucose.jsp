...
<html:errors/>
  ...
  <table cellpadding="3" >
    ...
    <logic:present name="glucoses" scope="session">
        <logic:iterate name="glucoses" id="glucose">
             <tr>
                 <td class="tablecell" align="center"><bean:write name="glucose" property="value.stringDate" /></td>
                 <td class="tablecell" align="center"><bean:write name="glucose" property="value.stringTime" /></td>
                 <td class="tablecell" align="center"><bean:write name="glucose" property="value.glucose" /></td>
                 <html:form action="/patient/patientDeletesGlucose">
                      <input type="hidden" name="glucosekey" value='<bean:write name="glucose" property="key" />' />
...
<html:form action="/patient/patientAddsGlucose">
    ...
    <tr>
        ...
        <td class="tablecell" align="center">
            <html:text property="glucose" size="3"/>
        </td>
    ...
    <logic:present name="glucoses" scope="session">
      <logic:notEmpty name="glucoses" scope="session">
        <tr>
          <td>&nbsp;</td>  
        </tr>
        <tr>
