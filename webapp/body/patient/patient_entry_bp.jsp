...
<html:errors/>
  ...
  <table cellpadding="3" >
    ...
    <tr>
      ...
      <td class="tableheader" align="center"><a href="http://www.renal.org/rixg/results/bp.html" target="_blank" title="Systolic blood pressure - Click for info">Sys</a></td>
      <td class="tableheader" align="center"><a href="http://www.renal.org/rixg/results/bp.html" target="_blank" title="Diastolic blood pressure - Click for info">Dia</a></td>
    </tr>
    ...
    <logic:present name="bloodPressures" scope="session">
        <logic:iterate name="bloodPressures" id="bloodPressure">
             <tr>
                 ...
                 <td class="tablecell" align="center"><bean:write name="bloodPressure" property="value.sys" /></td>
                 <td class="tablecell" align="center"><bean:write name="bloodPressure" property="value.dia" /></td>
                 <html:form action="/patient/patientDeletesBloodPressure">
                      <input type="hidden" name="bpkey" value='<bean:write name="bloodPressure" property="key" />' />
...
<html:form action="/patient/patientAddsBloodPressure">
    ...
    <tr>
        ...
        <td class="tablecell" align="center">
            <html:text property="sys" size="3"/>
        </td>
        <td class="tablecell" align="center">
            <html:text property="dia" size="3"/>
        </td>
